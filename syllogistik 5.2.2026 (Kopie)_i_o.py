...
def deduction_of_tetradic_total_formulas_from_triadic_level( *args):
    ...
    list_syllogistik_ganzformeln = [[['n', 'n', 'n', 'u', 'a', 'n', 'n', 'n'], ['$MaP$', '$SeM$', '$SaP$']] ,\
[['n', 'n', 'n', 'u', 'u', 'u', 'n', 'n'], ['$MaP$', '$SoM$', '$SiP$']] ,\
[['n', 'n', 'u', 'n', 'n', 'a', 'n', 'n'], ['$MaP$', '$S\\tilde{a}M$', '$S\\ddot{e}P$']] ,\
[['n', 'n', 'u', 'n', 'u', 'u', 'n', 'n'], ['$MaP$', '$S\\ddot{\\imath}M$', '$S\\tilde{o}P$']] ,\
[['a', 'n', 'n', 'n', 'n', 'n', 'n', 'u'], ['$MeP$', '$SeM$', '$SeP$']] ,\
[['u', 'u', 'n', 'n', 'n', 'n', 'n', 'u'], ['$MeP$', '$SoM$', '$SoP$']] ,\
[['n', 'a', 'n', 'n', 'n', 'n', 'u', 'n'], ['$MeP$', '$S\\tilde{a}M$', '$S\\tilde{a}P$']] ,\
[['u', 'u', 'n', 'n', 'n', 'n', 'u', 'n'], ['$MeP$', '$S\\ddot{\\imath}M$', '$S\\ddot{\\imath}P$']] ,\
[['n', 'n', 'u', 'n', 'n', 'u', 'u', 'n'], ['$MiP$', '$SaM$', '$S\\tilde{o}P$']] ,\
[['n', 'n', 'n', 'u', 'u', 'u', 'n', 'u'], ['$MiP$', '$SoM$', '$SiP$']] ,\
[['n', 'n', 'n', 'u', 'u', 'n', 'n', 'u'], ['$MiP$', '$S\\ddot{e}M$', '$SiP$']] ,\
[['n', 'n', 'u', 'n', 'u', 'u', 'u', 'n'], ['$MiP$', '$S\\ddot{\\imath}M$', '$S\\tilde{o}P$']] ,\
[['n', 'u', 'u', 'n', 'n', 'n', 'u', 'n'], ['$MoP$', '$SaM$', '$S\\ddot{\\imath}P$']] ,\
[['u', 'u', 'n', 'u', 'n', 'n', 'n', 'u'], ['$MoP$', '$SoM$', '$SoP$']] ,\
[['u', 'n', 'n', 'u', 'n', 'n', 'n', 'u'], ['$MoP$', '$S\\ddot{e}M$', '$SoP$']] ,\
[['u', 'u', 'u', 'n', 'n', 'n', 'u', 'n'], ['$MoP$', '$S\\ddot{\\imath}M$', '$S\\ddot{\\imath}P$']] ,\
[['n', 'n', 'a', 'n', 'n', 'u', 'n', 'n'], ['$M\\tilde{a}P$', '$SaM$', '$SeP$']] ,\
[['n', 'n', 'u', 'u', 'n', 'u', 'n', 'n'], ['$M\\tilde{a}P$', '$SiM$', '$SoP$']] ,\
[['n', 'n', 'n', 'a', 'u', 'n', 'n', 'n'], ['$M\\tilde{a}P$', '$S\\ddot{e}M$', '$S\\tilde{a}P$']] ,\
[['n', 'n', 'u', 'u', 'u', 'n', 'n', 'n'], ['$M\\tilde{a}P$', '$S\\tilde{o}M$', '$S\\ddot{\\imath}P$']] ,\
[['n', 'u', 'n', 'n', 'n', 'n', 'a', 'n'], ['$M\\ddot{e}P$', '$SaM$', '$SaP$']] ,\
[['n', 'u', 'n', 'n', 'n', 'n', 'u', 'u'], ['$M\\ddot{e}P$', '$SiM$', '$SiP$']] ,\
[['u', 'n', 'n', 'n', 'n', 'n', 'n', 'a'], ['$M\\ddot{e}P$', '$S\\ddot{e}M$', '$S\\ddot{e}P$']] ,\
[['u', 'n', 'n', 'n', 'n', 'n', 'u', 'u'], ['$M\\ddot{e}P$', '$S\\tilde{o}M$', '$S\\tilde{o}P$']] ,\
[['u', 'n', 'n', 'u', 'u', 'n', 'n', 'n'], ['$M\\ddot{\\imath}P$', '$SeM$', '$S\\ddot{\\imath}P$']] ,\
[['n', 'u', 'u', 'u', 'n', 'u', 'n', 'n'], ['$M\\ddot{\\imath}P$', '$SiM$', '$SoP$']] ,\
[['n', 'u', 'u', 'n', 'n', 'u', 'n', 'n'], ['$M\\ddot{\\imath}P$', '$S\\tilde{a}M$', '$SoP$']] ,\
[['u', 'n', 'u', 'u', 'u', 'n', 'n', 'n'], ['$M\\ddot{\\imath}P$', '$S\\tilde{o}M$', '$S\\ddot{\\imath}P$']] ,\
[['u', 'n', 'n', 'n', 'u', 'n', 'n', 'u'], ['$M\\tilde{o}P$', '$SeM$', '$S\\tilde{o}P$']] ,\
[['n', 'u', 'n', 'n', 'n', 'u', 'u', 'u'], ['$M\\tilde{o}P$', '$SiM$', '$SiP$']] ,\
[['n', 'u', 'n', 'n', 'n', 'u', 'u', 'n'], ['$M\\tilde{o}P$', '$S\\tilde{a}M$', '$SiP$']] ,\
[['u', 'n', 'n', 'n', 'u', 'n', 'u', 'u'], ['$M\\tilde{o}P$', '$S\\tilde{o}M$', '$S\\tilde{o}P$']]]
    ...
    with open('DUAL_syllogism_chain_05_08_2026__Beide.csv', 'w') as file:
                ...
                if (solution_and_contradiction_test[0] != 'W') and solution_and_contradiction_test[0] != ['u', 'u', 'u', 'u', 'u', 'u', 'u', 'u']:
                    ...
                    for solution_comparison in list_syllogistik_ganzformeln:
                        if solution_and_contradiction_test[0] == solution_comparison[0]:
                            ...
                            #print("-----------")
                            count = count + 1   
                            if formula_1[1][2][2:-2] == ("i" or "o" or "\\ddot{\\imath}" or "\\tilde{o}"):
                                
                                if solution_comparison[1][2][2:-2] == ("i" or "o" or "\\ddot{\\imath}" or "\\tilde{o}"):
                            ...
                            elif formula_2[1][2][2:-2] == ("i" or "o" or "\\ddot{\\imath}" or "\\tilde{o}"):
                                if solution_comparison[1][2][2:-2] == ("i" or "o" or "\\ddot{\\imath}" or "\\tilde{o}"):
                            ...
                            elif formula_1[1][2][2:-2] == ("i" or "o" or "\\ddot{\\imath}" or "\\tilde{o}") and \
                                 formula_2[1][2][2:-2] == ("i" or "o" or "\\ddot{\\imath}" or "\\tilde{o}"):
