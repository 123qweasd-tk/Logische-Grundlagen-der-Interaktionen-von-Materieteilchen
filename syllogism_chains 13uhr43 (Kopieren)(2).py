...
def syllogism_contradiction_test_tet_2( first_formula, second_formula, third_formula, fourth_formula):
...
[['u', 'u', 'a', 'n', 'u', 'u', 'u', 'n'], ['$M\\tilde{o}P$', '$S\\ddot{e}M$', '$SiP$']]]
    ...
    with open('syllogism 768_invers.csv', 'w') as file:
        ...
        for p, formula_1 in enumerate(liat_scheise):
            for r, formula_2 in enumerate(liat_scheise):
                ...
                solution_and_contradiction_test_2 = syllogism_contradiction_test_tet_2(third_formula_tri, second_formula_tri,  fourth_formula_tri, first_formula_tri)
                if ((solution_and_contradiction_test_2[0] != 'W') and solution_and_contradiction_test_2[0] != ['u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u'] ) and \
                   ((solution_and_contradiction_test[0] != 'W') and solution_and_contradiction_test[0] != ['u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u'] ):
                    count = count + 1
                    
                if ((solution_and_contradiction_test_2[0] != 'W') and solution_and_contradiction_test_2[0] != ['u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u']) or \
                   ((solution_and_contradiction_test[0] != 'W') and solution_and_contradiction_test[0] != ['u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u']):
                    count_1 = count_1 + 1
                    if solution_and_contradiction_test_2[0].count('a') >=1 or solution_and_contradiction_test_2[0].count('a') >=1:
                        count_2 = count_2 + 1
                        ...
                        if solution_and_contradiction_test_2[0] != 'W':
                            
                            writer.writerow([solution_and_contradiction_test_2[0], second_formula, third_formula, p, r])
                        else:
...
#solution_and_contradiction_test[0].count('u') == 1 --> one 'u' in total-formula
    ...
    print("doubles: ",count)
    print("deleted doubles and without existence-stipulation: ",count_1)
