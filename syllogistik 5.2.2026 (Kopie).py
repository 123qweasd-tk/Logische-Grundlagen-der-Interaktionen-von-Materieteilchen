...
def deduction_of_tetradic_total_formulas_from_triadic_level( *args):
    ...
    liat_scheise = [[['n', 'n', 'n', 'u', 'a', 'n', 'n', 'n'], ['$MaP$', '$SeM$', '$SaP$']] ,\
                ...
                for s, formula_3 in enumerate(liat_scheise):
                    for t, formula_4 in enumerate(liat_scheise):
                        ...
                        if (solution_and_contradiction_test[0] != 'W') and solution_and_contradiction_test[0] != ['u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u', 'u'] and solution_and_contradiction_test[0].count('a') >= 1 :
                            ...
                            writer.writerow([[solution_and_contradiction_test[0]], [first_formula],[second_formula],[third_formula], [fourth_formula]])
